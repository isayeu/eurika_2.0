...
from .core_handlers import handle_arch_history, handle_arch_summary, handle_arch_diff, handle_architect, handle_clean_imports, handle_cycle, handle_doctor, handle_explain, handle_fix, handle_help, handle_report, handle_scan, handle_self_check, handle_serve, handle_suggest_plan, handle_watch
