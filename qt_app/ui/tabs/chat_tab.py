...
def build_chat_tab(main: MainWindow) -> None:
    ...
    main.chat_feedback_not_btn.setToolTip("Ответ не подошёл — можно указать уточнение")
    ...
    buttons.addWidget(main.chat_feedback_helpful_btn)
    buttons.addWidget(main.chat_feedback_not_btn)
