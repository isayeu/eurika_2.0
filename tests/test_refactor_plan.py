...
def test_suggest_plan_from_risks() -> None:
    ...
    summary = {
        "risks": [
            "god_module @ project_graph_api.py (severity=11.00)",
            "bottleneck @ project_graph_api.py (severity=10.00)",
        ],
        "system": {},
        "maturity": "low",
    }
...
def test_suggest_plan_from_recommendations() -> None:
    ...
    recs = [
        "project_graph_api.py: introduce facade to reduce fan-in.",
        "agent_core_arch_review.py: split by domain.",
    ]
