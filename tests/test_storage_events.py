"""Tests for eurika.storage.events (unified Event model)."""
...
def test_project_memory_events(tmp_path: Path) -> None:
    """ProjectMemory.events is EventStore and persists to eurika_events.json."""
    ...
    assert (tmp_path / "eurika_events.json").exists()
