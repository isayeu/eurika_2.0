...
_Обновлено: v1.2.0. Детальный план — ROADMAP.md, контракт — SPEC.md._

---

## Статус

**Текущая версия:** v1.2.0 (CLI, bottleneck/god_module exemption *_api.py)
...
**Следующий шаг:** Релиз v1.2.0 → AST-based split extraction или стабилизация.
