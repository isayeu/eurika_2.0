...
_Обновлено: v1.2.2. Детальный план — ROADMAP.md, контракт — SPEC.md._

---

## Статус

**Текущая версия:** v1.2.2 (AST-based split_module)
...
**Следующий шаг:** Релиз v1.2.2; в перспективе Extract Class.
