...
```json
{
  "topics": {
    "python": [
      ...
      { "title": "What's New 3.12", "content": "..." }
    ],
    "python_3_12": [ { "title": "...", "content": "..." } ]
  }
}
```
...
**Пример файла:** скопируйте `docs/eurika_knowledge.example.json` в корень проекта как `eurika_knowledge.json` и при необходимости отредактируйте. Темы в примере: `python`, `python_3_12`, `architecture_refactor`, `deprecated_api`, `typing`, `cyclic_imports`, `version_migration`, `security`, `async_patterns`.
