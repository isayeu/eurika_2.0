...
### A. Продукт / UX
1. **Chat-first оболочка** — частично ✅ (2026-08-03…04): Chat первая вкладка; подвкладка **Агент**; полоска режимов Агент/Market/Обучение + статус Market; панель **Контекст** + **авто-Diff** pending-плана. Дальше: intents / goals вокруг агента (без большого рефактора «ради красоты»).
