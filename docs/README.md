...
| [MIGRATION_WEB_TO_QT.md](MIGRATION_WEB_TO_QT.md) | Миграция на Qt |
| [DOGFOODING.md](DOGFOODING.md) | Ритуал self-check |
| [API_BOUNDARIES.md](API_BOUNDARIES.md) | Публичные API подсистем (R4) |
| [DEPENDENCY_FIREWALL.md](DEPENDENCY_FIREWALL.md) | Правила layer/subsystem (R4) |
| [RELEASE_CHECKLIST.md](RELEASE_CHECKLIST.md) | Чеклист перед релизом |
| [R4_MODULAR_PLATFORM_PLAN.md](R4_MODULAR_PLATFORM_PLAN.md) | План Modular Platform |
