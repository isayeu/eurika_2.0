...
| ----------------------- | ------ | --------------------- | ------ |
| Архитектурная структура | 8.5/10 | Масштабируемость      | 6/10   |
| Качество кода           | 8/10   | Чистота структуры     | 4/10   |
| Концепция               | 9/10   | Контроль сложности    | 5/10   |
| Операционность          | 5/10   | Тестируемость         | ?      |
| Продуктовая готовность  | 6/10   | Продакшн-готовность   | 4/10   |
| Потенциал               | 9.5/10 |                       |        |
