...
DEFAULT_LAYER_PATH_RULES: tuple[LayerPathRule, ...] = (
    ...
    LayerPathRule(path_pattern="eurika/execution/", layer=4),
    ...
    LayerPathRule(path_pattern="patch_plan_extracted.py", layer=3),
    ...
    LayerPathRule(path_pattern="eurika/world_model/", layer=2),
    LayerPathRule(path_pattern="eurika/smells/", layer=2),
    LayerPathRule(path_pattern="eurika/knowledge/", layer=2),
    ...
    LayerPathRule(path_pattern="eurika/memory/", layer=0),
...
DEFAULT_LAYER_IMPORT_RULES: tuple[LayerImportRule, ...] = (
    ...
    LayerImportRule(import_prefix="eurika.execution", layer=4),
    ...
    LayerImportRule(import_prefix="patch_plan_extracted", layer=3),
    ...
    LayerImportRule(import_prefix="eurika.world_model", layer=2),
    LayerImportRule(import_prefix="eurika.smells", layer=2),
    LayerImportRule(import_prefix="eurika.knowledge", layer=2),
    ...
    LayerImportRule(import_prefix="eurika.memory", layer=0),
