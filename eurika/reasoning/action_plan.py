"""Action Plan v0.4 — formal planned actions (ROADMAP L3).

Pure data layer: no code modifications, consumed by executor sandbox.
Moved from root action_plan.py (consolidation).
"""
