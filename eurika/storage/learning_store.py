"""
LearningStore — append-only storage for self-refactoring outcomes (R2 consolidation).

Moved from architecture_learning.
"""
...
__all__ = ["LearningRecord", "LearningStore", "DEFAULT_LEARNING_FILE"]
