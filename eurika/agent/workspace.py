...
from .workspace_git import WorkspaceGitMixin
from .workspace_process import WorkspaceProcessMixin
...
class WorkspaceTools(WorkspaceGitMixin, WorkspaceProcessMixin):
